...
\begin{itemize}
	\item[1.] Frequent itemset generation i.e.\ itemsets with support $\geq minsup$
	\item[2.] Strong rules generation from the frequent itemsets 
\end{itemize}
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		\Procedure{Apriori}{T,$\epsilon$}
		\State $L_{1} \gets {1-temsets}$
		\State $k = 1$
		\BState \emph{\textbf{repeat}}:
...
Lift is a correlation measure based on \todo{definition}{Define Lift + equation}.
